      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              // Current Password
              _buildTextField('Current Password', 'Enter your current password',
                  TextInputType.text),
              ...
              // Confirm Password
              _buildTextField('Confirm Password', 'Re-enter your new password',
                  TextInputType.text),
      ...
      children: [
        Text(
          ...
          style: const TextStyle(
            ...
            fontFamily: 'PontanoSans-Medium', // Consistent app font
            fontSize: 18,
